...
void TreeWriter::InitializeECALTree(TTree * _hTree, ECAL_data & data)
{
  ...
  _hTree->Branch("sum_energy",          &data.sum_energy,          "sum_energy/F");
  _hTree->Branch("sum_energy_lg",       &data.sum_energy_lg,       "sum_energy_lg/F");

  _hTree->Branch("hit_slab", data.hit_slab, "hit_slab[nhit_len]/I");
  _hTree->Branch("hit_chip", data.hit_chip, "hit_chip[nhit_len]/I");
  _hTree->Branch("hit_chan", data.hit_chan, "hit_chan[nhit_len]/I");
  _hTree->Branch("hit_sca", data.hit_sca, "hit_sca[nhit_len]/I");
  ...
  _hTree->Branch("hit_adc_high", data.hit_adc_high, "hit_adc_high[nhit_len]/I");
  _hTree->Branch("hit_adc_low", data.hit_adc_low, "hit_adc_low[nhit_len]/I");
  ...
  _hTree->Branch("hit_n_scas_filled", data.hit_n_scas_filled, "hit_n_scas_filled[nhit_len]/I");
  _hTree->Branch("hit_isHit", data.hit_isHit, "hit_isHit[nhit_len]/I");
  _hTree->Branch("hit_isMasked", data.hit_isMasked, "hit_isMasked[nhit_len]/I");
  _hTree->Branch("hit_isCommissioned", data.hit_isCommissioned, "hit_isCommissioned[nhit_len]/I");
