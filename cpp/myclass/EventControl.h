...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/calice/TB2022-06/SiWECAL-TB-monitoring/data/eudaq_run_090121/full_run.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/calice/TB2022-06/SiWECAL-TB-monitoring/data/eudaq_run_090121/full_run.root");
      }
